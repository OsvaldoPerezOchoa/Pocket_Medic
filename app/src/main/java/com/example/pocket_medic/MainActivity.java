    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item)
    {
        switch (item.getItemId())
        {
            ...
            case R.id.nav_telefonos:
                getSupportFragmentManager().beginTransaction().replace(R.id.fragment_container,new TelefonosFragment()).commit();
                break;

            case R.id.nav_guias:
                getSupportFragmentManager().beginTransaction().replace(R.id.fragment_container,new GuiasFragment()).commit();
                break;
            ...
            case R.id.nav_direcciones:
                getSupportFragmentManager().beginTransaction().replace(R.id.fragment_container,new DireccionesFragment()).commit();
                break;
